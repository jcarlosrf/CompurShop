$(function () {
    $.widget("custom.combobox", {
        ...
        //class="custom-combobox-toggle ui-corner-right"
        _createShowAllButton: function () {
            ...
            var iconSpan = $("<span>")
                .addClass("ui-button-icon ui-icon ui-icon-triangle-1-s");

            var spaceSpan = $("<span>")
                .addClass("ui-button-icon-space")
                .text(" ");

            showAllButton.append(iconSpan, spaceSpan);

            showAllButton.appendTo(this.wrapper);
        },
    ...
    $("#listClientes").combobox();
    $("#toggle").on("click", function () {
        $("#listClientes").toggle();
    });

    $("#listClientesNew").combobox();
    $("#toggle").on("click", function () {
